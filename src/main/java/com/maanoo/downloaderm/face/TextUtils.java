...
public class TextUtils {
    ...
    public static String time(long time) {
        ...
        if(time < 60)
            ...
            return (time/3600) + " h " + ((time/60)%60) + " m " + (time%60) + " s";
        else
            return (time/86400) + " d " + ((time/3600)%24) + " h " + ((time/60)%60) + " m " + (time%60) + " s";
    }
    ...
    public static String speed(long speed) {
        ...
        if(speed < 3024) 
            return integer(speed) + " Bps";
        else if(speed < 3048576) 
            return integer(speed/1024) + " KBps";
        else 
            return integer(speed/1048576) + " MBps";
    }
    ...
    public static String integer(long num) {
        ...
        int size = 1;
        char sign = 0;
        char sep = Defs.NUMBER_SEPARATOR;
